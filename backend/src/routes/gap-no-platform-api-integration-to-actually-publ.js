...
const FEATURE_SLUG = 'no-platform-api-integration-to-actually-publ';
const FEATURE_TITLE = 'No platform API integration to actually publish (accounts route is registration only)';
const PROJECT = 'AISocialMediaManager';
